...
A system prototype with real GPU--CPU data movement on RTX 5080 confirms practical viability: the hierarchy matches full-cache accuracy with only 5--7\% transfer overhead, and scaling analysis projects 2--48\,GB HBM savings in production batch-serving scenarios.
...
\begin{itemize}
    ...
    \item We implement a system prototype with real GPU--CPU data movement, achieving 5--7\% transfer overhead and confirming accuracy preservation, with scaling projections showing 2--48\,GB HBM savings at production scale.
\end{itemize}
...
Hierarchy configurations match or exceed full-cache accuracy while keeping only 30--50\% of KV cache tokens in HBM.}
\label{tab:e2e}
\vskip 0.1in
\small
...
Our system prototype with real GPU--CPU data movement confirms these benefits translate to practice: the hierarchy matches full-cache accuracy (78\% vs.\ 76\%) with only 5--7\% transfer overhead and 14\% throughput loss, and scaling projections show KV cache offloading saves 2--48\,GB of HBM in production batch-serving scenarios.
